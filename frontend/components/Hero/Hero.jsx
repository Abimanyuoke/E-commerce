...
import { useAuthGuard } from '../../../frontend1/auth/middleware';
                            ...
                            <div className='grid grid-cols-1   sm:grid-cols-2'>
                                ...
                                <div className='order-1 sm:order-2'>
                                    <div
                                        ...
                                        <img src={data.img} alt="" className='w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto' />
                                    </div>
                                </div>
                            </div>
                        </div>
