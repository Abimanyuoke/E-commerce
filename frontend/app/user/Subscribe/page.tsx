...
import Banner from "../../../public/website/orange-banner.png";
...
const Subscribe = () => {
  return (
    <div data-aos="zoom-in" className='mb-20 bg-gray-100 dark:bg-gray-800 text-white' style={BannerImg} >
        <div className='container backdrop-blur-abim  py-10'>
            <div className='space-y-6 max-w-xl mx-auto'>
                <h1 className='text-2xl !text-center sm:text-left sm:text-4xl font-semibold'>Get Notified About New Products</h1>
                <input data-aos="fade-up" placeholder='Enter your email' type="text" className='w-full p-3'/>
            </div>
        </div>
    </div>
  )
